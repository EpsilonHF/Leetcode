...
"next":null,"right":{"$id":"4","left":null,"next":null,"right":null,"val":5},
"val":2},"next":null,"right":{"$id":"5","left":null,"next":null,"right":
...
"right":null,"val":4},"next":{"$id":"6","left":null,"next":null,"right":
{"$ref":"5"},"val":3},"right":{"$ref":"4"},"val":2},"next":null,"right":
{"$ref":"6"},"val":1}
...
class Solution:
    def connect(self, root: 'Node') -> 'Node':
        ...
        for i in range(1, len(nodes)-1):
            node, level = nodes[i]
            next_node, next_level = nodes[i+1]
            if level == next_level:
                node.next = next_node
            else:
                node.next = None
