"""
There is a robot starting at position (0, 0), the origin, on 
...
Input: "UD"
Output: true
Explanation: The robot moves up once, and then down once. All 
moves have the same magnitude, so it ended up at the origin 
...
class Solution:
    def judgeCircle(self, moves: str) -> bool:
        ...
        return pos['R'] == pos['L'] and pos['U'] == pos['D']
